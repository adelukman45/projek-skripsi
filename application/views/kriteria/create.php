...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-success"><i class="bi bi-plus"></i> Tambah Data Kriteria</h6>
    </div>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <input autocomplete="off" type="number" step="0.01" name="bobot" required class="form-control" />
